 ...
 */
final class Version20200605100922 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, restaurant_id INT NOT NULL, user_id INT NOT NULL, message LONGTEXT DEFAULT NULL, rating INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_794381C6727ACA70 (parent_id), INDEX IDX_794381C6B1E7706E (restaurant_id), INDEX IDX_794381C6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
